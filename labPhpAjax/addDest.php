<?php
    if($_POST) {
        ...
        // prepare and bind
        $stmt = $con->prepare("INSERT INTO destination (locationName, country, description, touristTarget, costPerDay) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssi", $loc, $country, $descr, $tourist, $cost);
        $stmt->execute();
